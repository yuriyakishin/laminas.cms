...
/**
 * @ORM\Entity(repositoryClass="\Yu\Content\Repository\PageRepository")
 * @ORM\Table(name="page", indexes={@ORM\Index(name="identifier_idx", columns={"identifier"}), @ORM\Index(name="active_idx", columns={"active"}), @ORM\Index(name="site_id_idx", columns={"site_id"})})
 */
class Page
{
    /**
