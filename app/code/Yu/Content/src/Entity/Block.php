...
namespace Yu\Content\Entity;

use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass="\Yu\Content\Repository\BlockRepository")
 * @ORM\Table(name="block", indexes={@ORM\Index(name="identifier_idx", columns={"identifier"}), @ORM\Index(name="active_idx", columns={"active"}), @ORM\Index(name="site_id_idx", columns={"site_id"})})
 */
class Block
{
    /**
