 ...
 * @ORM\Table(name="rubric", indexes={@ORM\Index(name="identifier_idx", columns={"identifier"}), @ORM\Index(name="active_idx", columns={"active"}), @ORM\Index(name="site_id_idx", columns={"site_id"}), @ORM\Index(name="sort_idx", columns={"sort"})})
 */
class Rubric
{
    /**
